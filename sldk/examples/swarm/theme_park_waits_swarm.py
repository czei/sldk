...
def main():
    """Run the flocking bird animation."""
    ...
    completion_time = None  # Track when text was completed
    ...
    def update_animation():
        ...
        if text_complete and completion_time is None:
            ...
            print("Program will end in 1 second...")
        
        # End program 1 second after completion
        if completion_time is not None and current_time - completion_time >= 1.0:
            print("Animation complete!")
            animation_complete = True
            return
        
        # If text is complete but we're in the 1-second grace period, make birds fly out
        if text_complete and len(flock) > 0:
            ...
            if (remaining_leds > 0 and 
                ...
                if remaining_leds <= 15:
                    ...
                    print(f"Flock of {birds_to_spawn} birds flying in from {direction} (targeting missing LEDs)")
