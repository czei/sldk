"""
Test module for image processor functionality
...
class Bitmap:
    ...
    def dirty(self, x1=0, y1=0, x2=-1, y2=-1):
        # pylint: disable=unnecessary-pass, invalid-name
...
def create_bitmap(width, height):
    ...
    return Bitmap(width, height, 256)

# Tried to use CircuitPython display libraries to create bitmap, but that failed
